...
<!--
```sh
$ npm install sails-generate-backend-liticed
```
-->
...
sailsgen(require('sails-generate-backend-liticed'), scope, function (err) {
	if (err) throw err;
...
```sh
$ git clone YOUR_FORK_OF_THIS_REPO sails-generate-backend-liticed-fork
$ cd sails-generate-backend-liticed-fork
$ npm install
$ node ./bin
```
